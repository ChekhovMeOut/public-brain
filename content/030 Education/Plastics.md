...
> - Now describes all ***aliphatic* polyamides** (Def: repeating units of [[030 Education/Chemical bonds\|amide bonds]]) 

> [!definition] Nylon 6,6
> - Repeating units of $\ce{– [NH–(CH₂)₆–NH–CO–(CH₂)₄–CO] –}$
...
- Synthesis
	- ![[nylon synthesis.avif| 400]]
	- Nylon 6,6
		- Same process globally
		- $Part\;1:\;\ce{HMD + AA -> nylon salt: [H3N^+-(CH2)6-NH3^+][^-OOC-(CH2)4-COO^-]}$
		- $Part\;2:\ce{ condensation under vacuum at 270C}$
		- Cool, pelletize, spin, do whatever
	- HMD - Hexaethylenediamine
		- Same general process globally, but people make custom catalysts
		- $\ce{NC-(CH2)4-CN + 4 H2 ->[Ni,~Raney~Ni] H2N-(CH2)6-NH2}$
	...
	- ADN - Adiponitrile
		...
		- $\ce{4 CH2=CH-CN + 2 H2O -> 2 NC-(CH2)4-CN + O2}$ (this is total reaction, not half)
		- Pulse voltage in a heavy metal CSTR at mild conditions, $\gamma = 0.80$
	...
	- AN - Acrylonitrile
		...
		- $\ce{C3H6 + NH3 + 1.5 O2 ->[BiMo] C3H3N + 3 H2O}$
